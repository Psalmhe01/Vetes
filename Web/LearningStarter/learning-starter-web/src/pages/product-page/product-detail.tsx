import { Anchor, Badge, Breadcrumbs, Card, Container, Grid, Skeleton, Table, Text } from "@mantine/core"
...
export const ProductDetail = () => {
    ...
    useEffect(() => {
        ...
        async function fetchProduct() {
            const response = await api.get<ApiResponse<ProductGetDto>>(`/api/products/${id}`);
        ...
        <Grid gutter="xl">
          ...
          <Grid.Col span={{ base: 12, sm: 7 }}>
            ...
            {product.sizes.length === 0 ? (
              ...
              <>
                <Text fw={500} mb="sm">Sizes and measurements</Text>
